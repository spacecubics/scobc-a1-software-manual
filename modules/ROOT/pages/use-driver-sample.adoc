...
Referring to the {scobc_a1_dev_overlay_link}[DTS overlay file for Development Board], it can be 
...
CAUTION: To read the DIP switch state, the corresponding GPIO line must not be used by another 
peripheral and the correct DIP switch bit must be toggled manually.
