...
:zephyr-win-install: https://docs.zephyrproject.org/latest/develop/getting_started/installation_win.html
:wsl-usb-connect: https://learn.microsoft.com/en-us/windows/wsl/connect-usb

[TIP]
====
For WSL2 users, refer to {zephyr-win-install}[the upstream Zephyr
installation guide]. If you need to access USB devices from WSL2
(for flashing/debugging), see {wsl-usb-connect}[Microsoft’s USB
connection guide].
