...
WSL2. Detailed instructions for WSL2 user are provided in the
...
When CON2 is connected to your Windows PC, you need to attach it to
WSL2 according to {wsl-usb-connect}[the Microsoft USB connection
guide].

To attach the device to WSL2, run `usbipd list` on Windows and
