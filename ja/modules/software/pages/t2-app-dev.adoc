...
*NOTE:* Currently monitoring interval is fixed by 1 second||*0:* Success +
...
If a non-zero value is returned, it may indicate that the voltage sensor data has not been updated within the FPGA. +
